...
insert into public.gift_catalog (gift_key, name, category, icon, coins, tier, animation, fullscreen, sound, is_lucky_box, sort) values
  ...
  ('diwali_sky','Diwali Sky','Legendary & Epic','🎆',999,'premium','',true,'fanfare',false,10),
  ('starlight_rocket','Starlight Rocket','Legendary & Epic','🚀',999,'premium','',true,'fanfare',false,20),
