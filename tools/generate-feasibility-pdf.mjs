#!/usr/bin/env node
// Renders public/feasibility-report.html → public/feasibility-report.pdf via headless Chrome.
// Same pattern as generate-updates-pdf.mjs.
...
const HTML_IN = path.join(ROOT, 'public', 'feasibility-report.html');
const PDF_OUT = path.join(ROOT, 'public', 'feasibility-report.pdf');
