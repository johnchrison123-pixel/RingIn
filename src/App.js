...
export default function App() {
  ...
  function renderScreen() {
    if (activeTab === 'home') return React.createElement(HomeScreen, {session:session, onViewExpert:function(exp){setSelectedExpert(exp);setActiveTab('search');}, onOpenWallet:openWallet});
